...
public class Apartment {
    ...
    public Apartment(int id, String name, String address, String videoTourUrl, PerUnitAmenities perUnitAmenities, CommonAmenities commonAmenities, SecurityFeatures securityFeatures, List<ApartmentUnit> units) {
        this.id = id;
        this.name = name;
        this.address = address;
        this.videoTourUrl = videoTourUrl;
